defmodule LessthanseventyWeb.CoreComponents do
  @moduledoc """
  ...
  import LessthanseventyWeb.Gettext
  ...
  attr :rest, :global, include: ~w(autocomplete cols disabled form max maxlength min minlengt
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LessthanseventyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LessthanseventyWeb.Gettext, "errors", msg, opts)
    end
  end
